...
def create_signature_table(doc):
    ...
    try:
        ...
        # 设置表格行高，留足签字空间
        sign_table.rows[0].height = Cm(3.1)
...
def create_content_table(doc, label, content):
    ...
    try:
        ...
        # 需要居中的字段
        center_fields = ["项目名称", "需求名称", "使用单位", "监理单位", "运维单位", "提出问题单位","日期", "运维人员"]
